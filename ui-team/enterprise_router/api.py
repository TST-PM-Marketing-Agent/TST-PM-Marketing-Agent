...
def create_app(settings: RouterSettings | None = None):
    ...
    def run_demo() -> dict[str, str]:
        from .demo_driver import simulation_manager
        simulation_manager.start(router)
        return {"status": "started"}

    @app.post("/demo/production-run")
    def run_production_demo() -> dict[str, str]:
        from .demo_driver import simulation_manager
        simulation_manager.start_production_run(router)
        return {"status": "started"}
